...
def get_parser():
    ...
    parser.add_argument(
        "--config-file",
        default="/home/lzr/projects/Entity/Entity/EntitySeg/configs/entity_swin_lw7_1x.yaml",
        metavar="FILE",
        help="path to config file",
    )
    parser.add_argument(
        "--input",
        default=sorted(glob.glob('/home/lzr/projects/Entity/Entity/EntitySeg/input_image/')),
        help="A list of space separated input images; "
        "or a single glob pattern such as 'directory/*.jpg'",
    )
    parser.add_argument(
        "--output",
        default='/home/lzr/projects/Entity/Entity/EntitySeg/output/',
